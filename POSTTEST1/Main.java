...
public class Main {
    ...
    public static void tampil_peserta() throws IOException{
        ...
        if (peserta.isEmpty()){
            ...
            for (int i = 0; i < peserta.size(); i++) {
                ...
                System.out.println("Nama Lengkap   : " + peserta.get(i).nama.toUpperCase());
                System.out.println("Jenis Kelamin  : " + peserta.get(i).jenis_kelamin.toUpperCase());
                System.out.println("NIK            : " + peserta.get(i).NIK);
                System.out.println("Usia           : " + peserta.get(i).usia + " Tahun");
                System.out.println("Alamat         : " + peserta.get(i).alamat.toUpperCase());
                System.out.println("Jenis Vaksin   : " + peserta.get(i).jenis_vaksin.toUpperCase());
                System.out.println("Dosis Terakhir : " + peserta.get(i).dosis);
                System.out.println("==================================================================================");
                System.out.println(" ");
            }
        }
    ...
    public static void edit_peserta() throws IOException{
        ...
        peserta.get(index-1).nama = setNAMA;
        peserta.get(index-1).jenis_kelamin = setJK;
        peserta.get(index-1).NIK = setNIK;
        peserta.get(index-1).usia = setUSIA;
        peserta.get(index-1).alamat = setALAMAT;
        peserta.get(index-1).jenis_vaksin = setJV;
        peserta.get(index-1).dosis = setDOSIS
                ;
