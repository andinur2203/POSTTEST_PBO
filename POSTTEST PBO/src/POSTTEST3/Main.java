...
public class Main {
    ...
    public static void tambah_peserta() throws IOException{
        ...
        switch (pilihan) {
            case 1 -> {
                ...
                Riwayat_Vaksin riwayat_vksBaru = new Riwayat_Vaksin(JV_anak, DV_anak, tgl_vaksin_anak, lokasi_vaksin_anak);
            ...
            case 2 -> {
                ...
                Riwayat_Vaksin riwayat_vksBaru = new Riwayat_Vaksin(JV_dewasa, DV_dewasa, tgl_vaksin_dewasa, lokasi_vaksin_dewasa);
    ...
    public static void tampil_peserta_anak() throws IOException{
        if (anak.isEmpty()){
            ...
            for (int i = 0; i < anak.size(); i++) {
                System.out.println("                            Peserta Vaksin Anak ke - " + (i+1));
                System.out.println("----------------------------------------------------------------------------------");
                System.out.println("+-+-+-+-+-+-                   DATA IDENTITAS DIRI                    -+-+-+-+-+-+");
                System.out.println("----------------------------------------------------------------------------------");
    ...
    public static void tampil_peserta_dewasa() throws IOException{
        if (dewasa.isEmpty()){
            System.out.println("--------------------- Data Peserta Vaksinasi COVID-19 Kosong ! ------------------");
            System.out.println(" ");
        } else {
            ...
            for (int i = 0; i < dewasa.size(); i++) {
                System.out.println("                          Peserta Vaksin Dewasa ke - " + (i+1));
                System.out.println("----------------------------------------------------------------------------------");
                System.out.println("+-+-+-+-+-+-                   DATA IDENTITAS DIRI                    -+-+-+-+-+-+");
                System.out.println("----------------------------------------------------------------------------------");
                //karena index itu 0 maka ditambah 1
